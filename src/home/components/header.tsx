...
const Header: React.FC = () => {
  ...
  return (
    <header className="relative z-50">
      ...
      <nav className={`absolute top-full left-0 right-0 bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border border-white/10 shadow-2xl mx-4 rounded-2xl overflow-hidden transform transition-all duration-500 ease-out md:hidden ${
